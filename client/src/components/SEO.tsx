  ...
  const servicesSchema = [
    {
      ...
      "description": "Instalação e retirada de Sistemas de Armazenamento Subterrâneo de Combustíveis com certificação CTBC vigente até 02/02/2029. Conformidade regulatória e rastreabilidade completa.",
      "provider": {
        "@type": "LocalBusiness",
        "name": "RR Engenharia"
      },
    ...
    },
    {
      ...
      "description": "Testes certificados de integridade de sistemas subterrâneos com certificação CTBC vigente até 02/02/2029. Relatórios técnicos para auditoria e conformidade regulatória.",
      "provider": {
        "@type": "LocalBusiness",
        "name": "RR Engenharia"
      },
    ...
    },
    {
      ...
      "description": "Construção, reforma e adequação de postos de abastecimento com governança de custo, prazo e segurança. Especialização em SASC.",
      "provider": {
        "@type": "LocalBusiness",
        "name": "RR Engenharia"
      },
