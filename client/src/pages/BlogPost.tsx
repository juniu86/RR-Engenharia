    ...
    return (
      <div className="min-h-screen flex flex-col bg-white">
        ...
        <div className="pt-32 text-center py-20">
          <h1 className="text-4xl font-bold text-[#001c3d]">Post não encontrado</h1>
          <Link href="/blog"><button className="mt-6 bg-[#0963ed] text-white px-6 py-2 rounded-lg">Voltar ao Blog</button></Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="pt-32 pb-12 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          <Link href="/blog" className="flex items-center gap-2 text-[#0963ed] hover:text-[#0752c4] mb-6">
            <ArrowLeft size={20} />
            Voltar ao Blog
          </Link>
          ...
          <div className="mb-8">
            ...
            <h1 className="text-5xl font-black text-[#001c3d] mb-4">{post.title}</h1>
          </div>

          <div className="prose prose-lg max-w-none text-gray-700 prose-h2:text-2xl prose-h2:font-bold prose-h2:text-[#001c3d] prose-h2:mt-8 prose-h2:mb-4 prose-h3:text-xl prose-h3:font-bold prose-h3:text-[#0963ed] prose-h3:mt-6 prose-h3:mb-3 prose-p:text-gray-700 prose-p:leading-relaxed prose-li:text-gray-700 prose-li:leading-relaxed" dangerouslySetInnerHTML={{ __html: post.content }} />
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-[#001c3d] to-[#002863] text-white">
        <div className="container mx-auto px-4 text-center max-w-2xl">
          ...
          <p className="text-xl mb-8 text-blue-100">Solicite uma consulta com nossos especialistas.</p>
